...
// Import Icon baru: Brain (Otak) & Scale (Timbangan Hukum)
...
const faculties = [
  ...
  { 
    id: 'fis', 
    name: 'FIS', 
    icon: <Scale size={30} />, // UPDATE: Icon Timbangan (Hukum/Sosial)
    color: 'bg-indigo-500', 
  ...
  { 
    id: 'fpsi', 
    name: 'Psikologi', 
    icon: <Brain size={30} />, // UPDATE: Icon Otak (Brain)
    color: 'bg-pink-500', 
...
// Animasi Container (Muncul berurutan)
const container = {
  hidden: { opacity: 0 },
  show: { opacity: 1, transition: { staggerChildren: 0.1 } }
};

// Animasi Item (Naik ke atas)
const item = {
      ...
      <div className="container mx-auto px-6">
        ...
        >
          {faculties.map((fac, index) => (
            ...
            >
              {/* Link ke Halaman Information dengan query parameter ID Fakultas */}
              <Link 
